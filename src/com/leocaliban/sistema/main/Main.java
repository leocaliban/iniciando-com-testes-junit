package com.leocaliban.sistema.main;
...
import com.leocaliban.sistema.domain.ContaCorrente;
import com.leocaliban.sistema.service.ClienteService;
import com.leocaliban.sistema.service.ContaCorrenteService;

public class Main {
	static ClienteService clienteService;
	static ContaCorrenteService contasService;
	...
	public static void main(String[] args) {
		...
		while (continua){
			...
			case 2:
				...
				ContaCorrente conta = contasService.pesquisaConta(idConta);
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Jack Bauer", 31, "bauer@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "David Palmer", 48, "dpalmer@gmail.com", conta02.getId(), true);
		Cliente cliente03 = new Cliente(3, "Nina Myers", 27, "nina@gmail.com", conta03.getId(), true);
		...
		contasService = new ContaCorrenteService(contasDoBanco);
